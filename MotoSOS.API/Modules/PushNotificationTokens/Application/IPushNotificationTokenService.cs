...
{
    Task<RegisterPushNotificationTokenResponse> RegisterAsync(string userId, string? sessionId, ValidatedRegisterPushNotificationTokenRequest request, CancellationToken cancellationToken);
