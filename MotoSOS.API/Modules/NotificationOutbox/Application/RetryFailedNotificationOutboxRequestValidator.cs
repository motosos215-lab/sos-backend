...
public sealed class RetryFailedNotificationOutboxRequestValidator : AbstractValidator<RetryFailedNotificationOutboxRequest>
{
    public RetryFailedNotificationOutboxRequestValidator()
    {
