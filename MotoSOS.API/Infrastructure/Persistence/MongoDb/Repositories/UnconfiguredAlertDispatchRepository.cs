...
public sealed class UnconfiguredAlertDispatchRepository : IAlertDispatchRepository
{
    ...
    public Task<IReadOnlyList<AlertDispatchRequest>> ListCandidatesForAutomaticEscalationAsync(DateTimeOffset cutoffUtc, int maxItems, CancellationToken cancellationToken) => throw CreateException();
