...
public sealed class OfflineProcessingServiceTests
{
    ...
    private static OfflineProcessingService Service(User user, Records records, Incidents? incidents = null, MinorEvents? minorEvents = null) => new(new Users(user), records, incidents ?? new Incidents(), new Alerts(), new Locations(), minorEvents ?? new MinorEvents(), new Clock());
